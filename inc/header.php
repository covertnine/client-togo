					...
					<div class="container">
						...
						<div class="navbar-small-buttons">
							...
							<div class="nav-order d-inline-block d-md-none">
								...
								if ( $count != 0 ) {
									echo '<div class="nav-woocommerce" itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"><a href="' . wc_get_cart_url() . '" title="Shopping Cart" class="nav-link"><span class="view-cart">' . __('View Cart', 'c9') . '</span> <i class="fa fa-shopping-cart fa-md"></i><span class="count">' . $count . '</span></a></div>';
